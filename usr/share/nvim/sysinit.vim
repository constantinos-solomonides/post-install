" Convenient defaults from SuSE installation
...
if myterm == "xterm" || myterm == "kvt" || myterm == "gnome"
    ...
    map! <ESC>Ok  +
    map! <ESC>Ol  ,
    map! <ESC>OM  | "A special character, ^M is mapped here
    map! <ESC>Ow  7
    map! <ESC>Ox  8
    map! <ESC>Oy  9
    map! <ESC>Ot  4
        ...
        function! GetTabListStatus()
          ...
          for l:j in range(tabpagenr('$'))
            ...
            for l:buffer in tabpagebuflist(l:j+1)
              ...
              if (index(l:term_buffers, l:buffer) != -1)
                let l:buffername = printf("%s [%s]", l:buffername, term_gettitle(l:buffer))
              endif
